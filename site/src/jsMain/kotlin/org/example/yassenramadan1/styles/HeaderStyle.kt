...
val ActiveHeaderLinkStyle = CssStyle {
    base {
        Modifier.styleModifier {
            property("--silk-link-default-color", "rgb(95, 212, 168) !important")
            property("--silk-link-visited-color", "rgb(95, 212, 168) !important")
            property("color", "rgb(95, 212, 168) !important")
        }
    }
}
