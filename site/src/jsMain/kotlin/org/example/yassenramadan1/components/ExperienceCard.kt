...
import org.example.yassenramadan1.styles.experienceDescriptionStyle
import org.example.yassenramadan1.styles.experienceNumberBarStyle
import org.example.yassenramadan1.styles.experienceNumberCircleStyle
        ...
        Box(
            modifier = Modifier
                ...
                .border(
                    ...
                    color = Theme.LightGreen.rgb
                )
                .backgroundColor(if (active) Theme.LightGreen.rgb else Colors.White)
            ...
            P(
                attrs = Modifier
                    ...
                    .fontSize(16.px)
                    .fontWeight(FontWeight.Bold)
                    .color(if (active) Colors.White else Theme.LightGreen.rgb)
                    .toAttrs()
            ) {
