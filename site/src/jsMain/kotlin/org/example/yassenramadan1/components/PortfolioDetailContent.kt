...
import org.example.yassenramadan1.models.LinkType
import org.example.yassenramadan1.models.Portfolio
import org.example.yassenramadan1.models.Theme
import org.example.yassenramadan1.services.AppStoreMetadata
import org.example.yassenramadan1.services.AppStoreService
import org.example.yassenramadan1.styles.AppStoreButtonStyle
import org.example.yassenramadan1.styles.InfoSectionStyle
...
private fun AppInfoSection(
    ...
    Column(
        ...
        val statusText = when (portfolio.status) {
            org.example.yassenramadan1.models.DevelopmentStatus.PRODUCTION -> "Available"
            org.example.yassenramadan1.models.DevelopmentStatus.IN_DEVELOPMENT -> "In Development"
            org.example.yassenramadan1.models.DevelopmentStatus.IN_TESTING -> "In Testing"
        }
